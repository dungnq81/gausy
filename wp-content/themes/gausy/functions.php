...
$text_domain   = ( wp_get_theme()->get( 'TextDomain' ) ) ?: 'gausy';
...
define( 'THEME_PATH', untrailingslashit( get_stylesheet_directory() ) . DIRECTORY_SEPARATOR ); // **/wp-content/themes/**/
define( 'THEME_URL', untrailingslashit( esc_url( get_stylesheet_directory_uri() ) ) . '/' ); // https://**/wp-content/themes/**/
