...
$social_follows_links = gausy_theme_setting_filters( 'social_follows_links', [] );
    ...
    <div class="option">
        <div class="controls control-img">
            <label for="<?=esc_attr( $key ) ?>">
                <?php
                if ( filter_var( $icon, FILTER_VALIDATE_URL ) || str_starts_with( $icon, 'data:' ) ) : echo '<img src="' . $icon . '" alt="' . esc_attr( $name ) . '">';
