...
$html_header      = gausy_custom_post_option_content( 'html_header', true );
$html_footer      = gausy_custom_post_option_content( 'html_footer', true );
$html_body_top    = gausy_custom_post_option_content( 'html_body_top', true );
$html_body_bottom = gausy_custom_post_option_content( 'html_body_bottom', true );
