...
$filter_custom_emails = gausy_theme_setting_filters( 'custom_emails', [] );
...
<div class="section section-text" id="section_emails">
    ...
    <div class="desc"><?php _e( 'The email addresses are separated by commas "comma".', ADDONS_TEXT_DOMAIN ); ?></div>
	<div class="option">
		<div class="controls">
