...
<div class="section section-checkbox" id="section_base_slug_post_type">
	...
	<div class="option mb-20">
        <label class="controls">
            <input type="checkbox" class="checkbox" name="base_slug_post_type[]" value="<?php echo esc_attr( $post_type->name ); ?>" <?php echo gausy_in_array_checked( $base_slug_post_type, $post_type->name ); ?>>
        </label>
...
<div class="section section-checkbox" id="section_base_slug_taxonomy">
	...
	<div class="option mb-20">
        <label class="controls">
            <input type="checkbox" class="checkbox" name="base_slug_taxonomy[]" value="<?php echo esc_attr( $taxonomy->name ); ?>" <?php echo gausy_in_array_checked( $base_slug_taxonomy, $taxonomy->name ); ?>>
        </label>
        <div class="explain"><?php echo $label; ?></div>
    </div>
	<?php endforeach; ?>
