...
<div class="section section-checkbox" id="section_custom_post_type_order">
    ...
    <div class="option mb-20">
        <label class="controls">
            <input type="checkbox" class="checkbox" name="order_post_type[]" value="<?php echo esc_attr( $post_type->name ); ?>" <?php echo gausy_in_array_checked( $order_post_type, $post_type->name ); ?>>
        </label>
...
<div class="section section-checkbox" id="section_custom_taxonomy_order">
    ...
    <div class="option mb-20">
        <label class="controls">
            <input type="checkbox" class="checkbox" name="order_taxonomy[]" value="<?php echo esc_attr( $taxonomy->name ); ?>" <?php echo gausy_in_array_checked( $order_taxonomy, $taxonomy->name ); ?>>
        </label>
        <div class="explain"><?php echo $label; ?></div>
    </div>
	<?php endforeach; ?>
