...
$display_descriptor = [
	...
	'suggested_products' => blocksy_get_theme_mod('added_to_cart_popup_show_suggested_products', 'yes'),
];
...
$products_content = blocksy_render_view(
	dirname(__FILE__) . '/views/suggested-products.php',
	[
		'product_id' => $product_id,
		'product' => $product,
		'display_descriptor' => $display_descriptor,
		'is_cutomize_preview' => $is_cutomize_preview
	]
);
...
if ($display_descriptor['show_continue']) {
	$panel_attr['data-popup-additional-close'] = 'button_click:.button-close';
}
